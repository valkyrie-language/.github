...
<template>
  <nav class="top-bar">
    ...
    <div class="actions">
      ...
      <a href="https://github.com/valkyrie-language" target="_blank" class="action-btn social-link">
      ...
      <a href="https://discord.gg/valkyrie" target="_blank" class="action-btn social-link">
